...
**Current release:** v2.0.21 · macOS (Intel + Apple Silicon) and Windows (x64)
...
| Windows (x64) | Supported via release `.exe` installer or ZIP |
| Linux | Not available for the Electron app yet |
