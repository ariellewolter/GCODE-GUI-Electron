...
"""
Portable PyInstaller spec for G-code Generator
Bundles all dependencies including tkinter for distribution to other Macs
"""
...
exe = EXE(
    ...
    target_arch=None,  # Auto-detect current architecture
